# Setting up OS
distro_family=$(cat /etc/os-release | grep "^ID_LIKE" | cut -b 9-20)
if [ ! -z $distro_family ]; then
	if [ $distro_family=='arch' ]; then
		echo "==========================INSTALLING DEPENDENCIES=========================="
		sudo pacman -Syyu --needed base-devel git wget yajl python3 python-is-python3 code snapd telegram-desktop discord gnome-tweaks mscorefonts-installer
		echo ""
